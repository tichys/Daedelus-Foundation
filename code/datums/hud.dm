...
//GLOBAL HUD LIST
GLOBAL_LIST_EMPTY(huds)

/proc/init_hud_list()
	GLOB.huds = list()
	GLOB.huds[DATA_HUD_SECURITY_BASIC] = new /datum/atom_hud/data/human/security/basic()
	GLOB.huds[DATA_HUD_SECURITY_ADVANCED] = new /datum/atom_hud/data/human/security/advanced()
	GLOB.huds[DATA_HUD_MEDICAL_BASIC] = new /datum/atom_hud/data/human/medical/basic()
	GLOB.huds[DATA_HUD_MEDICAL_ADVANCED] = new /datum/atom_hud/data/human/medical/advanced()
	GLOB.huds[DATA_HUD_DIAGNOSTIC_BASIC] = new /datum/atom_hud/data/diagnostic/basic()
	GLOB.huds[DATA_HUD_DIAGNOSTIC_ADVANCED] = new /datum/atom_hud/data/diagnostic/advanced()
	GLOB.huds[DATA_HUD_ABDUCTOR] = new /datum/atom_hud/abductor()
	GLOB.huds[DATA_HUD_SENTIENT_DISEASE] = new /datum/atom_hud/sentient_disease()
	GLOB.huds[DATA_HUD_AI_DETECT] = new /datum/atom_hud/ai_detector()
