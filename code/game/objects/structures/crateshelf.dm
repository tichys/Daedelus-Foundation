#define DEFAULT_SHELF_CAPACITY 4 // Default capacity of the shelf
...
/obj/structure/crate_shelf/attackby(obj/item/item, mob/living/user, params)
	...
	if(istype(item, /obj/item/stack/sheet/iron))
		if(capacity < max_capacity)
			var/obj/item/stack/sheet/iron/our_sheet = item
...
/obj/structure/crate_shelf/deconstruct(disassembled = TRUE)
	...
	if(!(flags_1&NODECONSTRUCT_1))
		...
		if(capacity >= 2)
			var/obj/item/stack/sheet/iron/new_metal = new(loc)
