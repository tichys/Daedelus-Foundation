...
/obj/item/clothing/head/helmet/scp/security
	...
	armor = list(melee = 40, bullet = 30, laser = 35, energy = 15, bomb = 10, bio = 5, rad = 5)

/obj/item/clothing/head/helmet/scp/security/ruined
	name = "\improper ruined foundation security helmet"
	desc = "A heavy non-descript helmet with built-in padding, and armor, however age has diminished its quality, scratching the paint off. It has a cracked, and shattered poly-carbonate yellow riot visor on it, devastating blow to its previous owner."
	icon_state = "forgotten-guard-helm"
	body_parts_covered = 1
	armor = list(melee = 30, bullet = 8, laser = 8, energy = 0, bomb = 5, bio = 0, rad = 0)
...
/obj/item/clothing/head/helmet/scp/security/lczcom
	...
	desc = "A heavy non-descript helmet with more built-in padding, and armor. The golden badge on the front of the helmet indicates the rank of 'Lieutenant', looks important. It has a poly-carbonate yellow riot visor on it."
...
/obj/item/clothing/head/helmet/scp/security/cadet
	...
	body_parts_covered = 1
	armor = list(melee = 45, bullet = 15, laser = 25, energy = 5, bomb = 5, bio = 5, rad = 5)
...
/obj/item/clothing/head/helmet/scp/hczsecurityofficer
	...
	body_parts_covered = 1
	armor = list(melee = 45, bullet = 45, laser = 40, energy = 15, bomb = 10, bio = 5, rad = 5)
