...
GLOBAL_LIST_INIT(channel_tokens, list(
	...
	RADIO_CHANNEL_CI = RADIO_TOKEN_CI,
	RADIO_CHANNEL_SCP_COMMAND = RADIO_TOKEN_SCP_COMMAND,
	RADIO_CHANNEL_SCP_SECURITY = RADIO_TOKEN_SCP_SECURITY,
	RADIO_CHANNEL_SCP_SCIENCE = RADIO_TOKEN_SCP_SCIENCE,
	RADIO_CHANNEL_SCP_MEDICAL = RADIO_TOKEN_SCP_MEDICAL,
	RADIO_CHANNEL_SCP_CONTAINMENT = RADIO_TOKEN_SCP_CONTAINMENT,
	RADIO_CHANNEL_SCP_MTF = RADIO_TOKEN_SCP_MTF,
	RADIO_CHANNEL_SCP_ENGINEERING = RADIO_TOKEN_SCP_ENGINEERING,
	RADIO_CHANNEL_SCP_DCLASS = RADIO_TOKEN_SCP_DCLASS
))
