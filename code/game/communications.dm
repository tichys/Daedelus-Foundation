...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_SCP_COMMAND = FREQ_SCP_COMMAND,
	RADIO_CHANNEL_SCP_SECURITY = FREQ_SCP_SECURITY,
	RADIO_CHANNEL_SCP_SCIENCE = FREQ_SCP_SCIENCE,
	RADIO_CHANNEL_SCP_MEDICAL = FREQ_SCP_MEDICAL,
	RADIO_CHANNEL_SCP_CONTAINMENT = FREQ_SCP_CONTAINMENT,
	RADIO_CHANNEL_SCP_MTF = FREQ_SCP_MTF,
	RADIO_CHANNEL_SCP_ENGINEERING = FREQ_SCP_ENGINEERING,
	RADIO_CHANNEL_SCP_DCLASS = FREQ_SCP_DCLASS
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_SCP_COMMAND]" = RADIO_CHANNEL_SCP_COMMAND,
	"[FREQ_SCP_SECURITY]" = RADIO_CHANNEL_SCP_SECURITY,
	"[FREQ_SCP_SCIENCE]" = RADIO_CHANNEL_SCP_SCIENCE,
	"[FREQ_SCP_MEDICAL]" = RADIO_CHANNEL_SCP_MEDICAL,
	"[FREQ_SCP_CONTAINMENT]" = RADIO_CHANNEL_SCP_CONTAINMENT,
	"[FREQ_SCP_MTF]" = RADIO_CHANNEL_SCP_MTF,
	"[FREQ_SCP_ENGINEERING]" = RADIO_CHANNEL_SCP_ENGINEERING,
	"[FREQ_SCP_DCLASS]" = RADIO_CHANNEL_SCP_DCLASS
))
