...
/datum/controller/subsystem/processing/station/Initialize(timeofday)
	selectable_traits_by_types = list()
	selectable_traits_by_types[STATION_TRAIT_POSITIVE] = list()
	selectable_traits_by_types[STATION_TRAIT_NEUTRAL] = list()
	selectable_traits_by_types[STATION_TRAIT_NEGATIVE] = list()
