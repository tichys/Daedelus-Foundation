...
/datum/site53_builder/proc/build_lcz(sx, sy)
	...
	new /obj/machinery/scp_monitoring_console(locate(sx + 16, sy + 14, z_level))
...
/datum/site53_builder/proc/build_hcz(sx, sy)
	...
	new /obj/machinery/scp_monitoring_console(locate(sx + 15, sy + 14, z_level))
...
/datum/site53_builder/proc/build_ez(sx, sy)
	...
	new /obj/machinery/scp_research_terminal(locate(sx + 7, sy + 5, z_level))
