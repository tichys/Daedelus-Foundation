...
/obj/item/modular_computer
	...
	var/device_theme = "scp_terminal" // Sets the theme for the main menu, hardware config, and file browser apps. Overridden by certain non-NT devices.
...
/obj/item/modular_computer/proc/alert_call(datum/computer_file/program/calling_program, alerttext, sound = 'sound/machines/twobeep_high.ogg')
