/datum/language/chinese
	name = "Mandarin"
	desc = "The most widely spoken variety of Chinese."
	key = "6"
	...
	syllables = list(
		...
		"hai", "han", "hang", "hao", "he", "hei", "hen", "heng", "hong", "hou", "hu", "hua", "huai", "huan",
		...
		"ru", "rua", "ruan", "rui", "run", "ruo", "sa", "sai", "san", "sang", "sao", "se", "sen", "seng", "sha",
		...
		"yue", "yun", "za", "zai", "zan", "zang", "zao", "ze", "zen", "zeng", "zha", "zhai", "zhan", "zhang", "zhao",
