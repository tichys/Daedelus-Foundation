...
/datum/scp3349_distortion_system
	var/obj/item/reagent_containers/glass/bottle/scp3349/owner
	var/next_tick = 0
	var/tick_interval = 4 SECONDS
	var/distortion_radius = 5

/datum/scp3349_distortion_system/New(obj/item/reagent_containers/glass/bottle/scp3349/new_owner)
	owner = new_owner
...
/datum/scp3349_anomaly_system/New(obj/item/reagent_containers/glass/bottle/scp3349/new_owner)
	owner = new_owner
...
/datum/scp3349_anomaly_system/proc/process_anomalies()
	...
	if(prob(chance))
		...
		owner.visible_message("<span class='danger'>Reality warps near [owner]!</span>")
...
/datum/scp3349_evolution_system/New(obj/item/reagent_containers/glass/bottle/scp3349/new_owner)
	owner = new_owner
...
/datum/scp3349_environment_system/New(obj/item/reagent_containers/glass/bottle/scp3349/new_owner)
	owner = new_owner
...
/datum/scp3349_research_system/New(obj/item/reagent_containers/glass/bottle/scp3349/new_owner)
	owner = new_owner
