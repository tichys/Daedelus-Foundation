...
/datum/controller/subsystem/psychological_persistence/Initialize()
	log_world("Psychological persistence subsystem initializing...")
	...
	log_world("Loading existing psychological data...")
...
/datum/psychological_persistence_manager/proc/load_existing_psychological_data()
	log_world("Psychological: Loading existing psychological data...")
	...
	log_world("Psychological: Loaded [length(mental_health_records)] mental health records")
