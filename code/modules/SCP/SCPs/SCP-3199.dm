...
/mob/living/carbon/human/scp3199
	name = "SCP-3199"
...
/mob/living/carbon/human/scp3199/Initialize()
	. = ..()
...
/mob/living/carbon/human/scp3199/proc/initialize_systems()
...
/mob/living/carbon/human/scp3199/UnarmedAttack(atom/A)
	. = ..()
	if(isliving(A))
		var/mob/living/L = A
...
/mob/living/carbon/human/scp3199/examine(mob/user)
	. = ..()
...
/obj/item/scp3199_egg
	...
	w_class = 4
	var/mob/living/carbon/human/scp3199/parent_entity
...
/obj/item/scp3199_egg/proc/hatch()
	...
	var/mob/living/carbon/human/scp3199/hatchling = new /mob/living/carbon/human/scp3199(egg_turf)
