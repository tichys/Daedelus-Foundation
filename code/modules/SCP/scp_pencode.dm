/proc/pencode2html(t)
	...
	t = replacetext(t, "\[adminlogo\]", "<img src = scp_admin.png>")
	t = replacetext(t, "\[englogo\]", "<img src = scp_eng.png>")
	t = replacetext(t, "\[mtflogo\]", "<img src = mtf.png>")
	t = replacetext(t, "\[loglogo\]", "<img src = log.png>")
	t = replacetext(t, "\[manlogo\]", "<img src = man.png>")
	t = replacetext(t, "\[medlogo\]", "<img src = scp_med.png>")
	t = replacetext(t, "\[scilogo\]", "<img src = scp_sci.png>")
	t = replacetext(t, "\[seclogo\]", "<img src = scp_sec.png>")
