			...
			switch(class_id)
				...
				if("security")
					jobs += list(
						...
						JOB_EZ_COMMANDER, JOB_SENIOR_EZ_GUARD, JOB_EZ_GUARD, JOB_JUNIOR_EZ_GUARD,
						JOB_LCZ_COMMANDER, JOB_SENIOR_LCZ_GUARD, JOB_LCZ_GUARD, JOB_JUNIOR_LCZ_GUARD,
						JOB_HCZ_COMMANDER, JOB_SENIOR_HCZ_GUARD, JOB_HCZ_GUARD, JOB_JUNIOR_HCZ_GUARD,
